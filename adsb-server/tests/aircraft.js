...
Test('/aircraft', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test Get List of Aircraft with Specificity get operation', function (t) {
            Mockgen().requests({
                path: '/aircraft',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/aircraft']['get']['responses']['200']['schema']);
